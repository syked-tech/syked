            ...
            <div className="row">
              <div className="col-12">
                <div className="inner_page">
                  <h2 className="mb-3  border-bottom other_heading">TERMS AND CONDITIONS</h2>
                  <div>
                    <p dir="ltr">Welcome to Syked</p>
                    <p dir="ltr">
                      These terms and conditions outline the rules and regulations for the use of
                      Syked Website, located at www.syked.co.za
                    </p>
                    <p dir="ltr">
                      By accessing this website we assume you accept these terms and conditions. Do
                      not continue to use syked if you do not agree to take all of the terms and
                      conditions stated on this page.
                    </p>
                    <p dir="ltr">
                      The following terminology applies to these Terms and Conditions, Privacy
                      Statement and Disclaimer Notice and all Agreements: &ldquo;Client&rdquo;,
                      &ldquo;You&rdquo; and &ldquo;Your&rdquo; refers to you, the person log on this
                      website and compliant to the Company&#39;s terms and conditions. &ldquo;The
                      Company&rdquo;, &ldquo;Ourselves&rdquo;, &ldquo;We&rdquo;, &ldquo;Our&rdquo;
                      and &ldquo;Us&rdquo;, refers to our Company. &ldquo;Party&rdquo;,
                      &ldquo;Parties&rdquo;, or &ldquo;Us&rdquo;, refers to both the Client and
                      ...
                      services, in accordance with and subject to, prevailing law of South Africa .
                    ...
                    <p dir="ltr">
                      We employ the use of cookies. By accessing Syked, you agreed to use cookies in
                      agreement with the Syked&rsquo;s Privacy Policy.
                    </p>
                    <p dir="ltr">
                    ...
                    <p dir="ltr">
                      Unless otherwise stated, Syked and/or its licensors own the intellectual
                      property rights for all material on www.syked.co.za. All intellectual property
                      rights are reserved. You may access this from Syked for your own personal use
                      subjected to restrictions set in these terms and conditions.
                    </p>
                    <p dir="ltr">You must not:</p>
                    <ul>
                      <li dir="ltr">
                        <p dir="ltr">Republish material from Syked</p>
                      </li>

                      <li dir="ltr">
                        <p dir="ltr">Sell, rent or sub-license material from Syked</p>
                      </li>

                      <li dir="ltr">
                        <p dir="ltr">Reproduce, duplicate or copy material from Syked</p>
                      </li>

                      <li dir="ltr">
                        <p dir="ltr">Redistribute content from Syked</p>
                      </li>
                    </ul>
                    <p dir="ltr">This Agreement shall begin on the date hereof.</p>
                    <p dir="ltr">
                      Parts of this website offer an opportunity for users to post and exchange
                      opinions and information in certain areas of the website. Syked does not
                      filter, edit, publish or review Comments prior to their presence on the
                      website. Comments do not reflect the views and opinions of Syked,its agents
                      ...
                      Syked shall not be liable for the Comments or for any liability, damages or
                      expenses caused and/or suffered as a result of any use of and/or posting of
                      and/or appearance of the Comments on this website.
                    </p>
                    <p dir="ltr">
                      Syked reserves the right to monitor all Comments and to remove any Comments
                      which can be considered inappropriate, offensive or causes breach of these
                      Terms and Conditions.
                    </p>
                    <p dir="ltr">You warrant and represent that:</p>
                    <ul>
                      <li dir="ltr">
                        <p dir="ltr">
                    ...
                    <p dir="ltr">
                      You hereby grant Syked a non-exclusive license to use, reproduce, edit and
                    ...
                    <ul>
                      <li dir="ltr">
                        <p dir="ltr">Government agencies;</p>
                      </li>

                      <li dir="ltr">
                        <p dir="ltr">Search engines;</p>
                      </li>

                      <li dir="ltr">
                        <p dir="ltr">News organizations;</p>
                      </li>
                    ...
                    <ul>
                      ...
                      <li dir="ltr">
                        <p dir="ltr">dot.com community sites;</p>
                      </li>

                      <li dir="ltr">
                        <p dir="ltr">associations or other groups representing charities;</p>
                      </li>

                      <li dir="ltr">
                        <p dir="ltr">online directory distributors;</p>
                      </li>

                      <li dir="ltr">
                        <p dir="ltr">internet portals;</p>
                      </li>

                      <li dir="ltr">
                        <p dir="ltr">accounting, law and consulting firms; and</p>
                      </li>

                      <li dir="ltr">
                        <p dir="ltr">educational institutions and trade associations.</p>
                      </li>
                    </ul>
                    <p dir="ltr">
                      ...
                      absence of Syked; and (d) the link is in the context of general resource
                      information.
                    </p>
                    <p dir="ltr">
                    ...
                    <p dir="ltr">
                      ...
                      to Syked. Please include your name, your organization name, contact
                    ...
                    <p dir="ltr">Approved organizations may hyperlink to our Website as follows:</p>
                    <ul>
                      <li dir="ltr">
                        <p dir="ltr">By use of our corporate name; or</p>
                      </li>

                      <li dir="ltr">
                        <p dir="ltr">By use of the uniform resource locator being linked to; or</p>
                      </li>
                    ...
                    <p dir="ltr">
                      No use of Syked&#39;s logo or other artwork will be allowed for linking absent
